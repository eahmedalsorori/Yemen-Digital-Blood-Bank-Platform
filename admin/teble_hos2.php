...
$sql = "SELECT *
FROM hospitals where h_id=".$_SESSION['hos_id'];
...
<td><a href="hosupdate2.php?id=<?php echo $row[0]; ?>">تعديل</a></td>
<td><a href="delete/delete_hos2.php?id=<?php echo $row[0]; ?>">حذف</a></td>
</tr>
<?php
 }
}
