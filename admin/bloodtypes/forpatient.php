<html lang="ar" dir="rtl">
  ...
  <body >
  <h3 class="text-center">اختيار متبرع من المتبرعين المتوفرين</h3>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
                <!--  -->
              <a href="view_donor.php?blood_type=1">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
                <!--  -->
                <a href="view_donor.php?blood_type=2">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=3">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=4">
...
ندرة وجودها، حيث إنّ (1.5 – 2%) من سكان الأرض يحملون هذه الفئة فقط، أي ما يعادل شخصين من كلّ (70-100) شخص. 
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=6">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=7">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="ud-single-blog">
              <div class="ud-blog-image">
              <a href="view_donor.php?blood_type=8">
