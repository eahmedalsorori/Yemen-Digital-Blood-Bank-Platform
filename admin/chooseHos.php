...
$incode=true;
$flag=2;
// flag =2 This is Old This's Old donors blood Time Out +6 Mother

}

}else{
  // flag =1 this is New donors 
  $flag=1;
  $new=true;
  ...
  echo "<hr><hr><hr><hr>Please<hr> Not <hr>Access <hr>found<hr> ERROR:<hr>:<hr>134 <hr>hkg<hr>";

}
  // flag = 2 This's Old donors blood Time Out +6 Mother
if( $flag==2 ){
    ?>
    ...
    <div class="card-body py-5 px-md-5" style="background-color:silver;">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="box">
          <b>          عدد مرات التبرع <?php echo $i; ?></b><br>
          <span>من تاريخ <?php echo date('Y-m-d',strtotime($date_created))."<hr>";?></span>
</div>
                      ...
                      <?php
                        ...
                        <div class="col">
                            <div class="card text-dark bg-light">
                                ...
                                <input type="hidden" name="hos_id" value="<?php echo $row[0];?>">
