...
<meta property="twitter:image" content="https://uideck.com/wp-content/uploads/2021/09/play-meta-bs.jpg">
  ...
  <body>
          ...
          <div class="col-lg-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="index.php">
                <img src="assets/images/logo/favicon.png" alt="Logo" style="max-height: 50px;" />
              </a>
              ...
              <ul id="nav" class="navbar-nav mx-auto ">
                  <li class="nav-item ">
                <a href="admin_login.php" class="ud-main-btn ud-login-btn">
                  الادارة
                </a>
                  </li>
                  <li class="nav-item">
                <a class="ud-main-btn ud-white-btn" href="create_account.php">
                  انشاء حساب
                </a>
                  </li>
                  <li class="nav-item">
                <a class="ud-main-btn ud-white-btn" href="call_me.php">
                  تواصل معنا 
                </a>
                  </li>
              </ul>
    ...
    <!-- ====== Hero Start ====== -->
    <section class="ud-hero" id="home" style='background-image: url("assets/images/b.jpg");
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            اهلا وسهلا بكم في بنك الدم اليمني  
              </h1>
            ...
            <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
              <img src="assets/images/hero/blood.jpg" alt="hero-image" />
              <img
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="login/direct.php" method="post">
      ...
      <div class="container">
        <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
          ...
          <div class="ud-about-image">
            <img src="assets/images/t.jpg" style="height:820px" alt="about-image" />
          </div>
        </div>
      </div>
    </section>
